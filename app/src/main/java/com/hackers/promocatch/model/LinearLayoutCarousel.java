...
public class LinearLayoutCarousel extends LinearLayout {
    private float scale = CarouselPagerAdapter.BIG_SCALE;

    public LinearLayoutCarousel(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LinearLayoutCarousel(Context context) {
        super(context);
    }
